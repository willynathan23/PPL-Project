<form action="" method="post" enctype="multipart/form-data">
    <div class="container mt-3 mb-3">
        <div class="row">
            <div class="col-6">
                <h1 class="display-4">Matakuliah</h1>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Add Matakuliah</h5>
    ...
    <table class="display" id="abs">
        ...
        <tbody>
            ...
            foreach ($matakuliah as $item) {
                ...
                echo '<tr>';
                echo '<td>' . $item->getKodeM() . '</td>';
                echo '<td>' . $item->getNamaM() . '</td>';

                echo '<td>
            <button class="btn btn-warning" type="button" onclick="editMatakuliah(\'' . $item->getKodeM() . '\')">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                </svg>
            </button>
            <button class="btn btn-danger" type="button" onclick="deleteMatkul(\'' . $item->getKodeM() . '\')">
        ...
        <script>
            ...
            function editMatakuliah(id) {
                window.location = 'index.php?ahref=upmatakuliah&mid=' + id;
            };

            function deleteMatkul(id) {
                const confirmation = window.confirm("Are you sure want to delete this data?")
                if (confirmation) {
                    window.location = "index.php?ahref=matakuliah&delcom=1&mid=" + id;
                }
            }
        </script>
    </table>
